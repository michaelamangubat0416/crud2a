...
const ItemForm = ({item, onSuccess}) =>{
    ...
    const handleSubmit = async(event) =>{
        ...
        const data={ first_name, middle_name, last_name, contact_num, email, address, zip_code, date_of_birth, place_of_birth, sex, civil_status, blood_type, fathers_given_name, fathers_middle_name, fathers_last_name, date_of_birth2, civil_status2, blood_type2, occupation, contact_number2, mothers_given_name, mothers_middle_name, mothers_last_name, date_of_birth3, civil_status3, blood_type3, occupation2, contact_number3};
        try{
            if(item){
                await 
